...
class AsteroidDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_asteroid_detail, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment AsteroidDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AsteroidDetailFragment().apply {
